        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarPlateNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    HasLinkedCard = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Properties",
                columns: new[] { "Id", "Bathrooms", "Bedrooms", "CreatedAt", "Description", "HasSmartParking", "ImageUrl", "IsSold", "ListingType", "Location", "Name", "Price", "PricePerHour", "PricePerNight", "Rating", "SalePrice", "Title", "TotalSpots" },
                values: new object[] { 1, 3, 4, new DateTime(2026, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Smart Villa with private parking", true, "https://images.unsplash.com/photo-1506521781263-d8422e82f27a", false, "Both", "Beverly Hills, Cairo", "Luxury Modern Villa", 1250.0m, 150.0m, 1250.0m, 4.9000000000000004, 2500000.0m, "Luxury Modern Villa", 90 });
